package id.ac.umn.week10_28059.TutorialC;
...
public class TutorialCMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_c_main);
        ...
        btnStartService.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TutorialCMainActivity.this,
                        CustomService.class);
                startService(intent);
            }
        });
