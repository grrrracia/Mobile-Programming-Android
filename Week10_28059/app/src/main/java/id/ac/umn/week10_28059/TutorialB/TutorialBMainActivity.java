package id.ac.umn.week10_28059.TutorialB;
...
import id.ac.umn.week10_28059.R;

public class TutorialBMainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Void> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_b_main);
    ...
    static class ContohLoader extends AsyncTaskLoader<Void> {
        static WeakReference<TutorialBMainActivity> mActivity;
        int mCounter = 0;
        public ContohLoader(@NonNull Context context, int n,
                            TutorialBMainActivity main) {
            super(context);
            mCounter = n;
            mActivity = new WeakReference<TutorialBMainActivity>(main);
        }
        @Nullable
        @Override
